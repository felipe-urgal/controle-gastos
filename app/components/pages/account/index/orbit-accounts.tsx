...
function MobileAccountsCenter({
  ...
  return (
    <div className="space-y-[22px] pb-3">
      <header className="flex items-start justify-between gap-4">
        ...
        <Link
          ...
          className="grid h-[52px] w-[52px] shrink-0 place-items-center rounded-full bg-[var(--orbit-primary)] text-[22px] text-white shadow-[0_12px_28px_color-mix(in_srgb,var(--orbit-primary)_28%,transparent)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus)]"
        >
      ...
      <section
        ...
        className="relative overflow-hidden rounded-[22px] border border-[var(--orbit-primary)]/55 bg-[linear-gradient(135deg,color-mix(in_srgb,var(--orbit-primary)_34%,var(--surface))_0%,color-mix(in_srgb,#312e81_42%,var(--surface))_58%,color-mix(in_srgb,#111827_88%,var(--surface))_100%)] p-[18px] shadow-[var(--shadow-surface)]"
      >
        <svg
          viewBox="0 0 180 90"
          className="pointer-events-none absolute -right-2 top-1 h-28 w-44 text-[var(--orbit-primary)] opacity-80"
          aria-hidden="true"
        >
          <path
        ...
        <div className="relative z-[1]">
          ...
          <strong className="mt-3 block break-words text-[36px] font-extrabold leading-none tracking-tight text-white min-[390px]:text-[38px]">
            {loading
              ? '—'
      ...
      <section aria-labelledby="mobile-accounts-title">
        <div className="mb-3 flex items-center justify-between gap-3">
          <h2
            ...
            className="text-[25px] font-extrabold tracking-tight text-[var(--foreground)]"
          >
            Minhas contas
          </h2>
        ...
        {loading ? (
          ...
          <>
            <div className="relative -mx-4 overflow-hidden px-7 py-0.5">
              {accounts.length > 1 && (
                <>
                  <div
                    className="pointer-events-none absolute inset-y-5 -left-7 w-16 rounded-[24px] border border-[var(--orbit-primary)]/30 bg-[linear-gradient(145deg,color-mix(in_srgb,var(--orbit-primary)_20%,var(--surface))_0%,var(--surface)_100%)] opacity-60"
                    aria-hidden="true"
                  />
                  <div
                    className="pointer-events-none absolute inset-y-5 -right-7 w-16 rounded-[24px] border border-[var(--orbit-primary)]/30 bg-[linear-gradient(215deg,color-mix(in_srgb,var(--orbit-primary)_20%,var(--surface))_0%,var(--surface)_100%)] opacity-60"
                    aria-hidden="true"
                  />
                  <button
                    type="button"
                    ...
                    className="absolute left-1 top-1/2 z-20 grid h-11 w-11 -translate-y-1/2 place-items-center rounded-full border border-[var(--orbit-primary)]/45 bg-[color-mix(in_srgb,var(--surface)_92%,transparent)] text-[var(--foreground)] shadow-[var(--shadow-surface)] backdrop-blur focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus)]"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-1 top-1/2 z-20 grid h-11 w-11 -translate-y-1/2 place-items-center rounded-full border border-[var(--orbit-primary)]/45 bg-[color-mix(in_srgb,var(--surface)_92%,transparent)] text-[var(--foreground)] shadow-[var(--shadow-surface)] backdrop-blur focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus)]"
                  >
              ...
              <article className="relative z-10 rounded-[26px] border border-[var(--orbit-primary)] bg-[linear-gradient(145deg,color-mix(in_srgb,var(--orbit-primary)_52%,var(--surface))_0%,color-mix(in_srgb,#312e81_44%,var(--surface))_48%,color-mix(in_srgb,#111827_86%,var(--surface))_100%)] p-5 shadow-[0_20px_44px_color-mix(in_srgb,var(--orbit-primary)_22%,transparent)]">
                <div className="flex items-start justify-between gap-3">
                  <div className="flex min-w-0 items-center gap-4">
                    <span
                      className="grid h-[64px] w-[64px] shrink-0 place-items-center rounded-[17px] text-2xl text-white shadow-[inset_0_0_0_1px_rgba(255,255,255,.14)]"
                      style={{ backgroundColor: selectedAccount.color || '#64748B' }}
                      aria-hidden="true"
                    >
                      <IconRenderer iconName={selectedAccount.icon || 'wallet'} size={27} />
                    </span>
                    <div className="min-w-0">
                      <h3 className="truncate text-[23px] font-extrabold text-white">
                ...
                >
                  <Link
                    ...
                    className="inline-flex min-h-[50px] items-center justify-center gap-2 rounded-[14px] border border-white/15 bg-black/10 px-3 text-sm font-semibold text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus)]"
                  >
                  ...
                  <Link
                    ...
                    className="inline-flex min-h-[50px] items-center justify-center gap-2 rounded-[14px] border border-[var(--orbit-primary)]/55 bg-[var(--orbit-primary)]/18 px-3 text-sm font-semibold text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus)]"
                  >
          ...
          <div className="space-y-2.5">
            {otherAccounts.map((account) => (
              <button
                ...
                className="flex min-h-[78px] w-full items-center gap-3 rounded-[17px] border border-[var(--border)] bg-[var(--surface)] p-3 text-left transition-colors hover:bg-[var(--surface-hover)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus)]"
              >
                <span
...
export default function OrbitAccounts() {
  ...
  return (
    <ProtectedRoute>
      ...
      <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="hidden flex-wrap gap-2 sm:flex">
          <Button
            variant="outline"
            icon={<FaSearch />}
            onClick={() => document.getElementById('accounts-search')?.focus()}
      ...
      <section
        className={`my-[18px] flex flex-col gap-2.5 sm:flex-row sm:items-center ${orbitActionTokens}`}
        aria-label="Buscar e filtrar contas"
      >
        <div className="min-w-0 flex-1">
          <Input
            id="accounts-search"
          ...
          {filterOptions.map((option) => {
            ...
            return (
              <button
                ...
                aria-pressed={active}
                onClick={() =>
                  setFilters((previous) => ({ ...previous, type: option.queryValue }))
                }
      ...
      <div className="grid min-w-0 items-start gap-4 min-[900px]:grid-cols-[minmax(520px,1.2fr)_minmax(390px,.9fr)]">
        <section
          className={`overflow-hidden rounded-[18px] border border-[var(--border)] bg-[var(--surface)] ${orbitActionTokens}`}
          aria-label="Portfólio de contas"
        >
          {loading ? (
            <div className="p-4">
            ...
            grouped.map((group) => (
              <section key={group.key} aria-label={group.title}>
                <h2 className="px-[18px] pb-2 pt-4 text-sm font-bold text-[var(--text-muted)]">
                  {group.title}
                </h2>
            ...
            <aside
              className={`${
                mobileDetailOpen
                  ...
                  : 'hidden'
              } min-[900px]:sticky min-[900px]:top-[18px] min-[900px]:block min-[900px]:max-h-[calc(100vh-36px)] min-[900px]:overflow-y-auto min-[900px]:rounded-[18px] min-[900px]:border min-[900px]:border-[var(--border)] min-[900px]:bg-[var(--surface)] ${orbitActionTokens}`}
              aria-label={`Detalhe da conta ${selectedAccount.name}`}
            >
              <div
                className="mx-auto mt-2 h-1 w-12 rounded-full bg-[var(--border-strong)] min-[900px]:hidden"
                aria-hidden="true"
              />
              <button
                ref={closeRef}
                ...
                className="absolute right-3 top-3 z-10 grid h-11 w-11 place-items-center rounded-[10px] text-[var(--text-muted)] hover:bg-[var(--surface-hover)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus)] min-[900px]:hidden"
              >
      ...
      <Link
        href="/contas/nova"
        aria-label="Nova conta"
        className="fixed right-[18px] z-30 grid h-[54px] w-[54px] place-items-center rounded-full bg-[var(--orbit-primary)] text-2xl text-white shadow-[var(--shadow-surface)] sm:hidden"
        style={{
          bottom:
            'calc(var(--app-mobile-bottom-nav-height) + env(safe-area-inset-bottom) + 1rem)',
        }}
      >
        <FaPlus aria-hidden="true" />
      </Link>
...
function AccountSummary({
  ...
  const metric =
    'rounded-[16px] border border-[var(--border)] bg-[var(--surface)] p-4 sm:px-[18px] sm:py-[17px]';

  return (
    <section
      className="mt-[22px] grid grid-cols-2 gap-2 lg:grid-cols-[1.35fr_.8fr_.8fr_1fr] lg:gap-3"
    ...
    >
      <article className={`${metric} col-span-2 lg:col-span-1`}>
        ...
        {loading ? (
          ...
          balancesByCurrency.map(([currency, value]) => (
            <strong
              key={currency}
              className={`mt-2 mr-3 inline-block text-xl font-bold sm:text-2xl ${
                value < 0 ? 'text-[var(--expense)]' : 'text-[var(--income)]'
              }`}
            >
              {money(value, currency, showValues)}
            </strong>
          ))
        )}
      ...
      <article className={`${metric} hidden lg:block`}>
        ...
        <strong
          className={`mt-2 block truncate text-xl font-bold ${
            latestActivity?.transaction?.type === 'INCOME'
              ? 'text-[var(--income)]'
              : latestActivity
                ? 'text-[var(--expense)]'
                : ''
        ...
        >
          {latestActivity
            ? transactionMoney(
                latestActivity.transaction,
                latestActivity.account.currency,
                showValues,
              )
            : '—'}
        </strong>
        <small className="block truncate text-xs text-[var(--text-muted)]">
          {latestActivity?.transaction?.description ?? 'Nenhuma movimentação'}
        </small>
      </article>
    </section>
  );
...
function AccountRow({
  ...
  return (
    <button
      ...
      className={`grid min-h-[68px] w-full grid-cols-[minmax(0,1fr)_105px_20px] items-center gap-2 border-t border-[var(--border)] px-3.5 py-3 text-left focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[var(--focus)] sm:grid-cols-[minmax(0,1fr)_150px_100px_34px] sm:gap-3.5 sm:px-[18px] ${
        selected
          ? 'bg-[var(--orbit-primary-subtle)] shadow-[inset_3px_0_0_var(--orbit-primary)]'
    ...
    >
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="truncate text-sm font-bold sm:text-base">{account.name}</p>
    ...
    <div className="p-4 sm:p-5">
      <header className="flex items-start justify-between gap-3 pr-10 min-[900px]:pr-0">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <h2 className="truncate text-xl font-bold sm:text-[22px]">{account.name}</h2>
            <p className="mt-0.5 truncate text-xs text-[var(--text-muted)]">
              {typeLabels[account.type]} · {account.currency}
            </p>
          </div>
        ...
        <span
          className={`hidden rounded-full border px-2 py-1 text-xs font-semibold min-[900px]:inline-flex ${
            account.isActive
              ? 'border-[var(--income)]/35 bg-[color-mix(in_srgb,var(--income)_12%,transparent)] text-[var(--income)]'
      ...
      <section
        className="my-[18px] grid gap-3 sm:grid-cols-[1.3fr_.9fr]"
      ...
      >
        ...
        <article className="rounded-[14px] border border-[var(--border)] bg-[var(--surface-raised)] p-[15px]">
          ...
          <small className="mt-1 block truncate text-xs text-[var(--text-muted)]">
            {latest?.description ?? 'Nenhuma movimentação'}
          </small>
        </article>
      </section>
      ...
      <nav className="grid grid-cols-2 gap-2 sm:grid-cols-4" aria-label="Ações da conta">
        <Link
          href={`/contas/alterar/${account.id}`}
          className="inline-flex min-h-11 items-center justify-center gap-2 rounded-[10px] border border-[var(--orbit-primary)]/40 bg-[var(--orbit-primary-subtle)] px-2 text-sm font-semibold text-[var(--orbit-primary)]"
        >
      ...
      >
        <div className="flex items-center justify-between gap-3">
          <p id="account-recent-title" className="text-xs text-[var(--text-muted)]">
            ÚLTIMAS TRANSAÇÕES
          </p>
          <Link
            href={`/transacoes?accountId=${encodeURIComponent(account.id)}`}
            className="rounded-[8px] border border-[var(--border)] px-2 py-1.5 text-xs font-semibold"
          >
            Ver todas
          </Link>
        </div>
          ...
          <div className="mt-2 divide-y divide-[var(--border)]">
            {recent.slice(0, 4).map((transaction) => (
              ...
              >
                ...
                >
                  {transactionMoney(transaction, account.currency, showValues)}
                </strong>
              </Link>
            ))}
          </div>
