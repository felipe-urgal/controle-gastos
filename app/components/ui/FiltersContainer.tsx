  ...
  return (
    <div className="bg-gray-800 p-3 border-b border-gray-700">
      <div className="flex flex-col sm:flex-row">
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-1 sm:gap-2">
          {showFilters && (
            <>
              {children}
            </>
      ...
      <div className="flex justify-end">
        <Button
          ...
          icon={icon}
          className="border-0 border-gray-0 hover:border hover:border-blue-900 hover:bg-sky-400"
        >
